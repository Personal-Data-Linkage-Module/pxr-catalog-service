...
import UpdateSetRegisterPutReqDto, { CatalogType } from '../dto/UpdateSetRegisterPutReqDto';
/* eslint-enable */
...
/**
 * 変更セット登録変更APIのバリデーションチェッククラス
 */
@Middleware({ type: 'before' })
export default class UpdateSetRegisterPutValidator implements ExpressMiddlewareInterface {

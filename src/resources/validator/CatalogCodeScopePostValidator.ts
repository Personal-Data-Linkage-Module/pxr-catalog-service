...
/**
 * カタログコード範囲追加APIのバリデーションチェッククラス
 */
@Middleware({ type: 'before' })
export default class CatalogCodeScopePostValidator implements ExpressMiddlewareInterface {
    /**
     * 対象タイプ
     */
    ...
    async use (request: Request, response: Response, next: NextFunction) {
        ...
        // パラメータを取得
        let dto = await transformAndValidate(CatalogCodeScopePostReqDto, request.body);

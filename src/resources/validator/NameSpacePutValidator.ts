...
/**
 * ネームスペース更新APIのバリデーションチェッククラス
 */
@Middleware({ type: 'before' })
export default class NameSpacePutValidator implements ExpressMiddlewareInterface {
    async use (request: Request, response: Response, next: NextFunction) {
        ...
        // パラメータを取得
        const dto = await transformAndValidate(NameSpacePutReqDto, request.body);

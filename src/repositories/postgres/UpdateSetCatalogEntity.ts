...
/**
 * 変更セットカタログテーブル エンティティクラス
 */
@Entity('catalog_update_set')
export default class UpdateSetCatalogEntity extends BaseEntity {
    /**
     * ID
     */
    ...
    public constructor (info: {}) {
        ...
        if (info) {
            ...
            this.catalogItemId = info['catalog_item_id'] ? Number(info['catalog_item_id']) : null;
            this.catalogItemCode = info['catalog_item_code'] ? Number(info['catalog_item_code']) : null;

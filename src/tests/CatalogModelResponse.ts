 ...
 * カタログレスポンス(モデル)
 */
export namespace CatalogModelResponse {
    /**
     * NULL設定オブジェクト
     */
    const NULL: any = null;
    ...
    */
    ...
    /**
    * カタログ(テンプレートプロパティinner各種設定、itemTemplate取得できない)
    */
    export const templatePropertyFullInnerNoitemTemplate = {
        catalogItem: {
            ns: 'catalog/model/cmatrix/unit-test',
            name: 'ユニットテスト',
            _code: {
        ...
        prop: [
            {
                ...
                type: {
                    ...
                    candidate: {
                        ns: [
                            'catalog/ext/test-org/unit-test/*',
                            'catalog/built_in/unit-test/*',
                            'catalog/model/unit-test/*'
                        ],
                        _code: [
    ...
    */
    ...
    /**
    * カタログ(テンプレートプロパティinner[]各種設定2(code: 196)を継承、templateがnull)
    */
